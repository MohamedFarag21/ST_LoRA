...
class EomtLoRAModule(pl.LightningModule):
    def __init__(self, ckpt=DEFAULT_CKPT, lora_r=8, lora_alpha=8, lora_dropout=0.1,
                 use_dora=False, target_modules=None, modules_to_save=None, fullft_modules=None,
        ...
        if fullft_modules:                       # decoder/mask-head full-FT on top of encoder LoRA
            n = 0
...
def parse_args():
    ...
    p.add_argument("--fullft_modules", nargs="+", default=None,
                   help="module-name substrings to fully fine-tune on top of LoRA (e.g. mask_head)")
