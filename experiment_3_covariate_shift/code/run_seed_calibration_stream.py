...
# These siblings are only needed by this file's __main__ CLI (the original res320 reproduction),
# not by StreamBinMetrics. Guard them so StreamBinMetrics imports standalone as a metrics library.
try:                                                                  # noqa: E402
